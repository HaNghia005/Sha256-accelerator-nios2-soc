...
/////////////////////////////////////////////////
// START CONTROL (Tạo xung 1 nhịp cho lõi SHA)
/////////////////////////////////////////////////
always @(posedge clk or negedge reset_n) begin
    if(!reset_n) begin
        ...
        if (write && address == 5'd16) begin
            ...
            // Lõi sha_core yêu cầu tín hiệu điều khiển là dạng xung (pulse).
            // Tự động clear sau 1 nhịp clock để tránh lỗi chạy lặp lại 2 lần.
            init_reg <= 1'b0;
            next_reg <= 1'b0;
        end
    end
...
always @(*) begin
    ...
    if(read) begin
        case(address)
            /////////////////////////////////////////
            // STATUS: Bit 0 = done latched, Bit 1 = ready, Bit 2 = digest_valid pulse
            /////////////////////////////////////////
            5'd16: readdata = {29'd0, digest_valid, ready, done_reg};
            5'd25: readdata = {31'd0, digest_valid};

            /////////////////////////////////////////
            // DIGEST / HASH (8 words = 256 bits)
            /////////////////////////////////////////
